...
for( const productCatalog of Catalog ){
    const cardProduct = `<div id="card-product">
<img src="./src/assets/img/${productCatalog.imagem}">
<p>${productCatalog.marca}</p>
<p>${productCatalog.nome}</p>
<p>R$ ${productCatalog.preco}</p>
